<script>
  ...
  import Simulations from './components/Simulation.svelte';
        ...
        <div class="simulations" id="simulations" class:hidden={$activeSection !== 'simulations' && $activeSection !== 'all'}>
          ...
          <div class="sim-list">
            <!-- <div class="simulation-wrapper">
              <a class="simulation" href="/">
                <div class="simulation-title">a</div>
                <div class="simulation-img">b</div>
                <div class="simulation-desc">c</div>
              </a>
            </div> -->
          </div>
        </div>
